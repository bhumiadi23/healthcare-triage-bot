...
SCENARIOS = [
    ...
    (["chest pain", "sweating", "shortness of breath"],   "CRITICAL", ["Myocardial Infarction", "Angina"],              "Call 911 immediately",            92, 0.95),
    (["facial drooping", "arm weakness", "slurred speech"],"CRITICAL", ["Stroke"],                                       "Call 911 immediately",            92, 0.98),
    (["sudden severe headache", "confusion"],              "CRITICAL", ["Subarachnoid Hemorrhage", "Meningitis"],         "Call 911 immediately",            92, 0.94),
    (["vomiting blood"],                                   "CRITICAL", ["GI Bleed"],                                     "Call 911 immediately",            92, 0.95),
    (["severe abdominal pain", "sweating"],                "CRITICAL", ["Ruptured Aortic Aneurysm", "Appendicitis"],     "Call 911 immediately",            92, 0.91),
    (["syncope", "palpitations"],                          "CRITICAL", ["Cardiac Arrhythmia", "Atrial Fibrillation"],    "Call 911 immediately",            92, 0.90),
    (["difficulty swallowing", "high fever"],              "CRITICAL", ["Epiglottitis"],                                 "Call 911 immediately",            92, 0.90),
    (["rash", "high fever", "confusion"],                  "CRITICAL", ["Meningococcemia", "Sepsis"],                    "Call 911 immediately",            92, 0.92),
    (["chest pain", "shortness of breath"],                "CRITICAL", ["Pulmonary Embolism", "Myocardial Infarction"],  "Call 911 immediately",            92, 0.93),
    (["arm weakness", "confusion", "dizziness"],           "CRITICAL", ["Stroke", "TIA"],                               "Call 911 immediately",            92, 0.92),
